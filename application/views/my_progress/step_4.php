...
<div class="col-md-12">
    <div class="row">
        <div class="col-md-4"><br>
            <div class="card">
                <a href = "<?= $this->config->base_url() . $progress_4->pet_picture ?>" data-toggle="lightbox" data-gallery="hidden-images" data-footer ="<b><?= $progress_4->pet_name ?></b>">
                    <img class="card-img-top" src = "<?= $this->config->base_url() . $progress_4->pet_picture ?>" alt="picture">
                </a>
                <div class="card-body">
                    <h4 class="card-title"><?= $progress_4->pet_name ?></h4>
                    <i class="fa fa-calendar"></i> <?= date('M. j, Y', $progress_4->pet_bday) ?><br>
                    <?php if ($progress_4->pet_sex == "Male" || $progress_4->pet_sex == "male"): ?>
                        <i class="fa fa-mars" style="color:blue"></i> <?= $progress_4->pet_sex ?><br>
                    <?php else: ?>
                        <i class="fa fa-venus" style="color:red"></i> <?= $progress_4->pet_sex ?><br>
                    <?php endif; ?>
                    <i class="fa fa-paw"></i> <?= $progress_4->pet_breed ?><br>
                    <i class="fa fa-check-square" style="color:green"></i> <?= $progress_4->pet_status ?>
                </div>

                <div class="card-footer text-center">
                    <div class = "btn-group" role="group" aria-label="Button Group">
                        <a href = "#" class = "btn btn-outline-secondary btn-md" data-toggle="modal" data-target=".<?= $progress_4->pet_id; ?>detail4"  data-placement="bottom" title="View Full Details"><i class = "fa fa-eye fa-2x"></i></a>
                        <a href = "#" class = "btn btn-outline-secondary btn-md" data-toggle="modal" data-target=".<?= $progress_4->pet_id; ?>medical4"  data-placement="bottom" title="View Medical Records"><i class = "fa fa-stethoscope fa-2x"></i></a>
        ...
        <div class="col-md-8">
            ...
            <p class = "text-muted">&emsp;<?= $progress_4->checklist_desc ?></p>
...
<!-- Modal Details -->
<div class="modal fade <?= $progress_4->pet_id; ?>detail4" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class ="col-md-5">
                        <img src = "<?= $this->config->base_url() . $progress_4->pet_picture ?>" class = "img-fluid" style = "border-radius:50px;  margin-top:20px;"/>
                    </div>
                    <div class ="col-md-7">
                        <table class = "table table-responsive table-striped">
                            <tbody>
                                <tr>
                                    <th>Name: </th>
                                    <td><?= $progress_4->pet_name; ?></td>
                                </tr>
                                <tr>
                                    <th>Status: </th>
                                    <td><?= $progress_4->pet_status; ?></td>
                                </tr>
                                <tr>
                                    <th>Size: </th>
                                    <td><?= $progress_4->pet_size; ?></td>
                                </tr>
                                <tr>
                                    <th>Birthday: </th>
                                    <td><?= date("F d, Y", $progress_4->pet_bday); ?></td>
                                </tr>
                                <tr>
                                    <th>Age:</th>
                                    <td><?= get_age($progress_4->pet_bday); ?></td>
                                </tr>
                                <tr>
                                    <th>Specie: </th>
                                    <td><?= $progress_4->pet_specie; ?></td>
                                </tr>
                                <tr>
                                    <th>Sex: </th>
                                    <td><?= $progress_4->pet_sex; ?></td>
                                </tr>
                                <tr>
                                    <th>Breed: </th>
                                    <td><?= $progress_4->pet_breed; ?></td>
                                </tr>
                                <tr>
                                    <th>Sterilized: </th>
                                    <td><?= $progress_4->pet_neutered_spayed == 1 ? "Yes" : "No"; ?></td>
                                </tr>
                                <tr>
                                    <th>Admission: </th>
                                    <td><?= $progress_4->pet_admission; ?></td>
                                </tr>
                                <tr>
                                    <th>Description: </th>
                                    <td><?= $progress_4->pet_description; ?></td>
                                </tr>
                                <tr>
                                    <th>Findings: </th>
                                    <td><?= $progress_4->pet_history; ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
...
<!-- Modal Medical -->
<?php $medical = $this->MyProgress_model->get_animal_medical_records(array("medical_record.pet_id" => $progress_4->pet_id))[0]; ?>
<div class="modal fade <?= $progress_4->pet_id; ?>medical4" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
...
<!-- Modal Video -->
<div class="modal fade <?= $progress_4->pet_id; ?>video4" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
