                        ...
                        <form method = "POST" action = "<?= base_url()?>PetManagement/edit_medical_record_submit/<?= $record->medicalRecord_id?>">   
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name = "medicalRecord_weight" value = "<?= set_value("medicalRecord_weight", $record->medicalRecord_weight);?>" class="form-control" id="medicalRecord_weight" placeholder="Weight">
                                </div>
                            </div>
