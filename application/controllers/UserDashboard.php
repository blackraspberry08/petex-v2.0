...
class UserDashboard extends CI_Controller {
    ...
    public function index() {
        ...
        $allAdopted = $this->UserDashboard_model->fetchJoinThreeAdoptedDesc("adoption", "pet", "adoption.pet_id = pet.pet_id", "user", "adoption.user_id = user.user_id", array("user.user_id" => $this->session->userdata("userid")))[0];
