...
if (!empty($transaction)): {
        redirect(base_url() . "PetAdoption/warning");
    }
    ?>
<?php else: ?>
                        ...
                        <form method="POST" enctype="multipart/form-data" action ="petAdoptionOnlineForm_send/<?= $pet->pet_id ?>">
                            ...
                            <div class ="row container">
                                ...
                                <div class="form-group col-sm-4 <?php if (!empty($form_error['numhome'])): ?>has-danger<?php else: ?>has-success<?php endif; ?>">
                                    <input type="text" class="form-control <?php if (!empty($form_error['numhome'])): ?>is-invalid<?php else: ?><?php endif; ?>" name = "numhome" value = "<?= $set_value["numhome"] ?>" >
                                ...
                                <div class="form-group col-sm-4 <?php if (!empty($form_error['numwork'])): ?>has-danger<?php else: ?>has-success<?php endif; ?>">
                                    <input type="text" class="form-control <?php if (!empty($form_error['numwork'])): ?>is-invalid<?php else: ?><?php endif; ?>" name = "numwork" value = "<?= $set_value["numwork"] ?>" >
                            ...
                            <div class ="row container mb-2">
                                ...
                                <div class="form-group col-sm-6 <?php if (!empty($form_error["num1"])): ?>has-danger<?php else: ?>has-success<?php endif; ?>">
                                    ...
                                    <textarea id="num1" name="num1" class="form-control <?php if (!empty($form_error["num1"])): ?>is-invalid<?php else: ?><?php endif; ?>" ><?= $set_value["num1"] ?></textarea>
