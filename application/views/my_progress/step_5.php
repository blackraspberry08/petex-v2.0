...
<?php if (!empty($schedule_5)): ?>
            ...
            <div class="col-md-4"><br>
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <i class="fa fa-check-square" style="color:green"></i> <?= $progress_5->pet_status ?>
                    </div>
                ...
                <?php if ($progress_5->progress_isSuccessful == 0): ?>
                    <div class="card">
                        <form action="step5_comment/<?= $progress_5->progress_id ?>" method="POST">
    ...
    <!-- Modal Medical -->
    <?php $medical = $this->MyProgress_model->get_animal_medical_records(array("medical_record.pet_id" => $progress_5->pet_id))[0]; ?>
    <div class="modal fade <?= $progress_5->pet_id; ?>medical5" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <!-- Modal Video -->
    <div class="modal fade <?= $progress_5->pet_id; ?>video5" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
