        ...
        $('#step_5_approve').click(function(){
            $.ajax({
                ...
                "data": {
                    ...
                    'schedule_desc': "Visiting Chosen Adoptee is done (83%)! Home Visit will be the next step for <?= $transaction->user_firstname." ".$transaction->user_lastname?> to adopt <?= $transaction->pet_name?>.",
